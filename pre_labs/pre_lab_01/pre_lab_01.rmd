...
**Answer: I'm not sure what the %s are doing, but I think the first line is selecting the dataset to look at, the second line is filtering the data by a specific condition, and the third and fourth lines are telling us how many classes fit into these specific conditions — which, in this case, would be the term they're offered.**
...
**Answer: This code arranged the data in descending order by how many classes were offered during each term.**
...
**Answer: This codeblock added another condition, the department that data is in, which adjusted the count of classes offered in a specific term and under a specific department.**
