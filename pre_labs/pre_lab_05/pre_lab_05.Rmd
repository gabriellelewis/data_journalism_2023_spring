...
or you can hit the green "Preview & Export Extracted Data" button on the top right. You should see something very like this:
...
**Answer** R read the first row of the data as column names.
...
**Answer** There aren't appropriate column names, and there's still periods in the jurisdiction names.
...
**Answer** We need to get rid of the periods in the jurisdiction names.
