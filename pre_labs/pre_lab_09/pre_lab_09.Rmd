...
https://datawrapper.dwcdn.net/4qTnA/1/
...
**Answer**The map now only shows the state of Maryland and its counties.
...
**Answer** Now when you hover over a county on the map, you see the name of the county rather than the FIPS code and the percentage of vote share Wes Moore had for each jurisdiction.
...
**Answer** https://datawrapper.dwcdn.net/dm8KS/1/
