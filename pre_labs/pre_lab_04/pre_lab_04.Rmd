...
**Answer** There are some grantees whose names are similar enough that they probably are from the same company, but because the names are typed slightly differently, they're considered separate grantees.
...
**Answer** Some of the names in the grantee_clean column are in a different typecase, likely because it combined similar grantee names. There are also some names that aren't the same as the original Grantee column, such as "Charles County Arts Alliance Inc" in the original and "CHARLES COUNTY ARTS ALLIANCE" in grantee_clean.
...
**Answer** refinr combined some of the grantees' names, which can be seen by the difference in typecase between names in Grantee and grantee_clean. "Washington Adventist University", "Washington College", and "Washington County Community Action Council" are three grantee names that refinr combined similar spellings.
...
**Answer** There aren't substantial differences here compared to the key_collision_merge function.
