...
**Answer** They do have the same column structure, although the order of the columns in 2016 and 2018 are the same while the order of the columns for 2020 and 2022 are the same.
...
**Answer** For all parties except LIB or GRN, the numbers of registered voters has increased from 2016 to 2022. For LIB and GRN, registration dipped in 2020 notably before picking back up in 2022.
...
**Answer** There are 24 rows, which is how many there should be.
...
**Answer** Prince George's County has the highest percentage for 18+ Black population and highest percentage of Democrats in the county.
...
**Answer** Howard County has the highest percentage for 18+ Asian population, but it doesn't have the highest percentage of Democrats. It has about 53%, while Prince George's County still has the most at about 77%.
...
**Answer** It's a double (number) column.
...
**Answer** It's now a character column.
