...
**Answer** There are the five fields as previously stated. Going through each page of the data, states that Trump won are higher up in businesses receiving PPP, and states Clinton won are on the lower end.
...
**Answer** Based on the plot, the percent of votes that went to Trump and PPE percentage businesses received are positively correlated. The higher the Trump votes percentage, the higher the PPP percentage is. However, several points aren't close to the line of best fit, so this relationship isn't the strongest.
...
### Task 4: Plot data
**Task** Run the following code. Describe the plot. What do you see?
**Answer** Compared to the previous plot, the line of best fit is flatter, which indicates less of a relationship between votes for Trump and PPP amount per employee.
...
**Answer** We get a short table that reveals the correlation coefficient between businesses_receiving_ppe_pct and ppe_amount_per_employee with pct_trump. The correlation coefficient between businesses_receiving_ppe_pct and pct_trump is about 0.52, and the correlation coefficient between ppe_amount_per_employee and pct_trump is about 0.22.
...
**Answer** The output shows us the correlation value we previously calculated and the p-value, which is 0.00008607, which is extremely low.
...
**Task** Run the following code. Describe the model output. What do you see?
**Answer** The output again shows the correlation value we previously calculated, but the p-value is much higher between these two variables at 0.1189.
...
**Answer** The output illustrates the mean PPP amount per employee and mean PPP percentage businesses are receiving for states Clinton won in 2016 vs. states Trump won. The mean values for mean PPP amount per employee and mean PPP percentage businesses receive are both higher for Trump-won states than the mean values for Clinton-won states.
...
**Answer** The output shows the two means we calculated as well as the t value and p value. These values illustrate that there's a higher likelihood we could've attained this relationship randomly.
...
### Task 10: Run t-test
**Task** Run the following code. Describe the output. What do you see?
**Answer** We again see the mean values we previously calculated. The values of the t value and p value can give us more confidence that these results are statistically significant and not just random.
