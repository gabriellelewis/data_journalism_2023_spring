...
**Answer** The variable 'releases' contains a dataframe with four columns: date, title, url, and text.
...
**Answer** This function pulls out all the "unique" terms in a_list_of_words and removes any repeats.
...
**Answer** We get a dataframe of over 647,000 words mentioned in Cardin's press releases.
...
**Answer** Not really - the top 25 words are mostly short articles like "the", "a", "to", etc.
...
**Answer** These results are much more interesting that the previous words dataframe. The words below are unique and pertain to political topics/issues that Cardin mentions in his press releases.
...
**Answer** The three dataframes show the top 10 words mentioned in Cardin's press releases during 2021, 2022, and 2023 respectively. Cardin consistently mentions health often during press releases from all 3 years. It's also interesting to note that in 2021, Cardin mentions COVID-19 more, but in the 2022 and 2023 dataframes, COVID-19 doesn't show up in the top 10 words.
...
**Task** Run the following code and describe the results.
**Answer** The results show the top two-word phrases in 2021 press releases. The top phrase is COVID-19. Other top phrases pertain to public health and healthcare.
...
**Task** Run the following code and describe the results.
**Answer** In this dataframe for the top two-word phrases for 2022, COVID-19 is lower on the list. The top phrase is "project location," and other phrases include locations within the state such as Baltimore City.
...
**Task** Run the following code and describe the results.
**Answer** This top 10 list of two-word phrases in 2023 is much more different compared to the 2021 and 2022 lists. The top phrases in this list include "human rights", "equal rights", and "health care".
...
**Answer** These words alone seem to have correct sentiments, but the words are also taken out of context. For example, in the 2023 bing words dataframe, "supreme" has a positive sentiment — but it's possible Cardin could be actually criticizing the Supreme Court if that's how the word is being used.
