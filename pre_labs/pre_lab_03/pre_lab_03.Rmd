...
**Answer** The first line means that there are some rows in the data that don't match up with R's guesses. Following the instructions and using the function problems() shows where these errors are.
...
**Answer** There are no parsing errors, likely due to the fact that R is looking at all the rows now instead of just a small section to guess the column types.
...
**Answer** There are 540 zip codes that do not have 5 characters.
...
**Answer** The headers are all standardized now as "one word" by turning two-word columns into all lowercase with _ replacing the spaces. One word columns are also all lowercase now.
...
**Answer** I skipped this accidentally and went ahead and cleared the duplicate rows.
...
**Answer** This displays rows that qualify by displaying 5-character zip codes.
