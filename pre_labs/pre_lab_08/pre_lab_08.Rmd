...
**Answer** The first line is creating a variable to hold all the code we're writing after it. The second line is creating a new column in this dataframe called month, and it's utilizing the month() function. The label=TRUE provides an abbreviation for each month. The third line groups the data by this new column, the fourth line summarizes the data as the total number of calls during each month, and the fifth line arranges the data from highest to lowest number of calls.
...
**Answer** We see a gray box as previously stated.
...
**Task** Run the following code. Explain what you see after running the code in the space below.
**Answer** We get a bar chart with the months along the x-axis and the number of calls on the y-values.
...
**Answer** The months have been reordered from lowest number of calls to highest number of calls
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The chart is now a vertical bar chart instead of a horizontal bar chart.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The theme has been applied to the chart. The main change is that the background has been changed to be a white grid over a gray grid.
...
**Answer** The chart's theme is different and is now The Economist's theme.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock?
**Answer** The chart title, caption and axis labels have been changed.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** The code groups the data by individual dates and shows the total number of calls under each date.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** The code below has created a line chart showing the number of calls for every single date in the dataframe.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** There's now labels on the x axis for each weekly interval in the dataframe, but the labels all overlap one another.
...
**Task** Run the following code. Explain what you see after running the code in the space below. 
**Answer** The labels for each week have been shifted so now they're all legible.
