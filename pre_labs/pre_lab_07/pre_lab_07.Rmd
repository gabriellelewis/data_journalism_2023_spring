...
```{r echo=FALSE}
census_api_key("03fc61c94846a9ef5b3700a6ba67b208cad5953f", install=TRUE)
```
...
**Answer** The state with the largest percentage growth is Nevada, with a percentage growth of about 35%.
...
**Answer** Howard County has the highest median household income of $129,549.
...
**Answer** Baltimore City, Allegany County, and Calvert County saw significant increases in median income, with percentage changes of 32% and above. Baltimore City had the largest percentage increase of about 37%. Based on this data, no counties had their median incomes fall.
...
**Answer** One question we could ask of this data is which high schools have the highest number of graduates, and what is the estimated household income for those high schools? Something that could make the answer harder to interpret is the fact that there are rows that have been excluded from this data that don't have income estimates, so we may not be getting the full picture of each high school.
...
**Answer** High schools that have 60% or more graduates immediately enrolling in college have an average income of about $111,000, while high schools that have less than 40% of graduates immediately enrolling in college have an average income of about $69,000.
...
**Answer** What is the average income for high schools with 250 or less students who graduated, and what is the average income for high schools with more than 250 student who graduated?
