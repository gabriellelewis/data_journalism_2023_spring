...
**A3** Keith Yearwood in the department of Geographical Sciences
...
**A4** Being able to exclude "NA" as an instructor name would've made the process of finding the instructor in one department with the highest number of courses taught faster.
...
**A5** I wanted to know which department has the highest number of instructors. The Business and Management department has the highest number of instructors at 1726. To me, the answer is interesting just because I was expecting for Computer Science or a STEM department to have the highest number of instructors.
